...
type Settings = { lang: Lang; setLang: (l: Lang) => void }

const Ctx = createContext<Settings>({ lang: 'de', setLang: () => {} })
...
/** Translate a backend enum value (clause type, contract type, …) through a lookup; falls back to the raw value. */
